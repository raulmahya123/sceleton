...
addGeoJSONToMapAndTable('./json/geojsonLinestring.json', map, document.getElementById('myTableId'));
addGeoJSONToMapAndTable('./json/goejsondrawPoint.json', map, document.getElementById('myTableId'));
addGeoJSONToMapAndTable('./json/geojsonPloygon.json', map, document.getElementById('myTableId'));
